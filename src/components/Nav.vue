      ...
      <router-link to="/" class="navbar-brand fw-bold" style="font-size: 30px;">PetWise</router-link>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
  <router-link to="/" class="nav-link active" aria-current="page" style="font-size: 20px;">Homepage</router-link>
</li>

<li class="nav-item">
  <a @click="scrollToVeterinarians" class="nav-link active" aria-current="page" style="font-size: 20px; cursor: pointer;">Veterinarians</a>
</li>
<li class="nav-item">
  <a @click="scrollToAddressAndContact" class="nav-link active" aria-current="page" style="font-size: 20px; cursor: pointer;">Address & Contact</a>
</li>
